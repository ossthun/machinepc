...
const regularErVerbs = [
  ...
  "anticiper", "apercevoir", "aplanir", "applaudir", "apprécier", "apprivoiser",
  ...
  "contribuer", "convaincre", "convier", "coopérer", "coordonner",
  "creuser", "cultiver", "déballer", "débarquer", "débloquer",
  "déborder", "débrancher", "débuter", "déchirer", "déclencher",
  "décliner", "décolorer", "décommander", "décourager", "décrire",
  "dédier", "déformer", "dégager", "dégeler", "déjeuner",
  "délivrer", "deménager", "démontrer", "dénoncer", "dépasser",
  ...
  "élargir", "élever", "éliminer", "emballer", "embarquer",
  "embêter", "embrouiller", "émigrer", "emmêler", "émouvoir",
  "empiler", "encadrer", "enchaîner", "encourir", "endommager",
  "endormir", "endurcir", "énerver", "enfermer", "enfoncer",
  "engager", "englober", "engraisser", "enlever", "ennuyer",
  "enregistrer", "enrichir", "enseigner", "entasser", "entourer",
  ...
  "verser", "vérifier", "vider", "vieillir", "viser",
